...
const ProductDetail = () => {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-b from-slate-600 to-slate-900 min-h-screen pt-20">
        <div className="max-w-6xl mx-auto p-4 py-8">
          ...
          <div className="bg-gray-800 rounded-xl shadow-sm overflow-hidden">
            <div className="flex flex-col lg:flex-row animate-pulse">
              <div className="w-full lg:w-1/2 h-96 bg-gray-600"></div>

              <div className="p-6 lg:p-8 lg:w-1/2">
                <div className="h-8 bg-gray-600 rounded w-3/4 mb-4"></div>
                <div className="h-6 bg-gray-600 rounded w-1/4 mb-8"></div>

                <div className="h-4 bg-gray-600 rounded w-full mb-2"></div>
                <div className="h-4 bg-gray-600 rounded w-full mb-2"></div>
                <div className="h-4 bg-gray-600 rounded w-3/4 mb-8"></div>
  ...
  return (
    <div className="bg-gradient-to-b from-slate-700 to-slate-900 min-h-screen pt-20">
      <div className="max-w-6xl mx-auto p-4 py-8">

        <nav className="flex mb-6 text-sm" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li className="inline-flex items-center">
              <a href="/" className="text-gray-100 hover:text-green-600">
                {t('home')}
              </a>
            </li>
            <li>
              <div className="flex items-center">
                ...
                <a href="/farmermarketplace" className="text-gray-100 hover:text-green-600">
                  {t('marketplace.title')}
                </a>
              </div>
            </li>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="p-6 lg:p-8 flex flex-col lg:w-1/2">
              <div className="flex-grow">
                ...
                {/* Additional Details */}
                <div className="mb-8">
                  <h3 className="text-lg font-semibold mb-4 text-gray-200 border-b border-gray-600 pb-2">
                    {t('additional_details')}
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {product.category && (
                      <div className="flex items-center">
                        <span className="text-gray-200 mr-2">{t('category')}:</span>
                        <span className="font-medium text-gray-400">{product.category}</span>
                      </div>
                    )}
                    {product.stock && (
                      <div className="flex items-center">
                        <span className="text-gray-200 mr-2">{t('stock')}:</span>
                        <span className="font-medium text-gray-400">{product.stock} {t('available')}</span>
                      </div>
                    )}
                    {product.condition && (
                      <div className="flex items-center">
                        <span className="text-gray-200 mr-2">{t('condition')}:</span>
                        <span className="font-medium text-gray-400">{product.condition}</span>
                      </div>
                    )}
                    {product.manufacturer && (
                      <div className="flex items-center">
                        <span className="text-gray-200 mr-2">{t('manufacturer')}:</span>
                        <span className="font-medium text-gray-400">{product.manufacturer}</span>
                      </div>
                    )}
                    {product.sku && (
                      <div className="flex items-center">
                        <span className="text-gray-200 mr-2">{t('sku')}:</span>
                        <span className="font-medium text-gray-400">{product.sku}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {product.seller && (
                  <div className="mb-8">
                    ...
                    <div className="flex items-center p-4 bg-gray-700 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium text-gray-200">{t('seller_id')}: {product.seller}</p>
                        <p className="text-sm text-gray-400">{t('member_since')}: {new Date().getFullYear()}</p>
                      </div>
                    </div>
                  </div>
                )}
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-gray-100 mb-6">{t('related_products')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* This would be populated with actual related products */}
            <div className="bg-gray-800 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
              ...
              <div className="p-4">
                <h3 className="font-bold text-gray-200">{t('similar_product')}</h3>
