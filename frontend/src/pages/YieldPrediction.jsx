  ...
  <div className="flex flex-col space-y-2">
    ...
    <div className="relative">
      ...
      <select
        ...
        value={value} // Passed from parent
        onChange={onChange} // Passed from parent
        className="w-full bg-gray-700/50 border border-gray-600 text-gray-100 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block pl-10 p-2.5 appearance-none transition-all"
        required
      >
            ...
            {result ? (
              <div className="bg-gray-800 border-2 border-green-600/50 rounded-xl p-6 shadow-2xl h-full flex flex-col animate-slide-up-1">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-gray-400 uppercase tracking-wider text-sm mb-1">
                    Estimated Yield
                  </h3>
