                    ...
                    <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                            {cart.map((product, index) => (
                                <div key={index} className="bg-gray-700 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 flex flex-col h-full">
                                    ...
                                    <div className="px-5 py-3 bg-gray-700 border-t border-gray-500 flex justify-between">
                                        <button
                        ...
                        <div className="bg-gray-700 rounded-xl shadow-sm p-6 mb-8">
                            ...
                            <div className="border-t border-gray-500 pt-4">
                                <div className="flex justify-between mb-2">
                                    <span className="text-gray-300">{t('items')}:</span>
